...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Agu 2024 pada 07.17
...
(6, 'gowoo', 'legoo', '$2y$10$7IKnGIHS/ZpGbtEP9in4mu.l/.qmtKBd9JGjOPo1I5Ht0SaZbbu7G', 'Lumintang', '082340942274', 'user', '2024-01-06 23:54:35', '2024-01-06 23:57:29');
...
(10, 'Bisnis Digital', 'Ega', 2, '2001', NULL, NULL, NULL),
(11, 'Mencari Jodoh', 'Natale', 2, '2023', NULL, '2024-01-07 19:14:18', '2024-01-07 19:16:53');
...
--
ALTER TABLE `tb_anggota`
  MODIFY `id_member` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `tb_buku`
--
ALTER TABLE `tb_buku`
  MODIFY `id_buku` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `tb_peminjam`
  MODIFY `id_pinjam` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
COMMIT;
